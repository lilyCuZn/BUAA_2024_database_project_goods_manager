# Generated by Django 3.2.25 on 2024-12-09 15:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('In', '库中'), ('BORROWING', '租赁中'), ('IN_MAINTENANCE', '维护中'), ('DAMAGE', '损坏')], max_length=20)),
            ],
            options={
                'db_table': 'material',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('REN', '租赁'), ('RET', '归还')], max_length=3, verbose_name='申请类型')),
                ...
                ('status', models.CharField(choices=[('待确认', 'Waiting'), ('通过', 'Approve'), ('拒绝', 'Refuse')], max_length=4, null=True)),
            ],
            options={
                'verbose_name': '用户申请',
        ...
        migrations.AddField(
            model_name='leasereturn',
            name='userApplyId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.userapplication'),
        ),
        migrations.AddField(
